function [dataSimulation] = dataSimulation_GGG_pro(n,ds,SNRgc,SNRlc,SNRd,noises,sparse_ratio)
% This function will be used to simulate three blocks
% Gaussian-Gaussian-Gaussian data sets
